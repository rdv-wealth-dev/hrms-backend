...
// Validation below 
if (!exports.env.connectionString) {
    throw new Error("MONGO_CONNECTION_STRING is missing in .env, kindly check!");
}
if (!exports.env.jwtSecret) {
    throw new Error("JWT_SECRET missing in .env, kindly check!");
}
